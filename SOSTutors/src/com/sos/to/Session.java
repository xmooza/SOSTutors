...
public class Session implements Serializable {
	...
	public Session(int sessionID, String subject, boolean booking_available, Timestamp booking_date,
			String booking_location, int tutors_tutorID, int categories_categoryID, int students_studentID) {
