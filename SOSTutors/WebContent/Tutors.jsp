        ...
        <div class="container-fluid filterform">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <button id="advancedbtn" class="btn btn-default input-lg" type="button">Advanced</button>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <button id="searchbtn" class="btn btn-default input-lg" type="submit">Search</button>
                </div>
            </div>
        </div>
                    ...
                    <div class="tutorform">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12 tutinfo">
                                <button id="tutinfobtn" class="btn btn-default input-lg" type="submit">More Info</button>
                            </div>
                        </div>
                    </div>
                </div>
