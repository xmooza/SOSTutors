...
<body>
	...
	<div class="content">
		...
		<div class="container-fluid form blackform col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
			<div class="row">
			
				<!-- REGISTER -->
				<div class="col-sm-12 col-md-12" style="padding: 25px; color: white;">
					<div class="titlebar">
					...
					<form name="LoginForm" action="registerServlet" method="post">
						<div class="col-sm-4">
		                    <img ng-src="https://placehold.it/192x192" alt="" src="https://placehold.it/192x192">
		                </div>
		                <div class="col-sm-8">
		                    <h4>Your Photo</h4>
		                    <p>Make a first good impression, the better your photo the more bookings you will receive. The best photos are professional looking headshots, 
		                    not full-body shots.In other words, just your shoulders and up ideally. And make sure it’s just 
		                    you in the photo. Think about which photo you would want to send in to get a job interview that is what we need. </p>
		                    ...
		                    <input class="btn btn-default greenbtn" type="file" name="file" value="Upload image" 
		                    style="float: right; width: 30%; margin-top: 25px"/>
		                    <br>
		                </div>
