		...
		<div class="container-fluid form blackform col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6" style="padding: 25px;">
					<div class="titlebar">
						<h4><%out.println(lang.getString("login"));%></h4>
					</div>
					<br/>
					<form name="LoginForm" action="loginServlet" method="post">
						<h4 style="color: white"><%out.println(lang.getString("email"));%></h4>
						<input type=text name=loginUseremail maxlength=100 class="form-control" value="" /><br />
						...
						<input class="btn btn-default greenbtn" type=submit value="<%out.println(lang.getString("login"));%>" style="float: right; width: 45%"/>
						<br />
					</form>
				</div>
